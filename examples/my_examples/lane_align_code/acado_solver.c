...
{
RDy1[0] = + (real_t)1.0000000000000000e+03*Dy1[3];
RDy1[1] = +Dy1[4];
}
...
acadoWorkspace.QDy[40] = 0.0;
;
acadoWorkspace.QDy[41] = +acadoWorkspace.DyN[0];
acadoWorkspace.QDy[42] = +acadoWorkspace.DyN[1];
acadoWorkspace.QDy[43] = +acadoWorkspace.DyN[2];
...
tmpDy[3] = + acadoWorkspace.Dy[lRun1 * 5 + 3]*(real_t)1.0000000000000000e+03;
